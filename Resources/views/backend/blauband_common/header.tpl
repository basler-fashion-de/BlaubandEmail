{block name="header"}
<script type="text/javascript" src="{link file="backend/_public/src/vendor/jquery-ui-1.12.1.custom/external/jquery/jquery.js"}"></script>
...
<script type="text/javascript" src="{link file="backend/_public/src/js/mail.js"}"></script>

<link rel="stylesheet" href="{link file="backend/_public/src/css/common.css"}">
